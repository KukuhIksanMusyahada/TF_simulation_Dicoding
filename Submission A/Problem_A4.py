...
def solution_A4():
    ...
    training_labels_final, testing_labels_final = np.array(training_labels), np.array(testing_labels)
    ...
    model.fit(padded, training_labels_final, batch_size= batch_size,
              epochs= MAX_EPOCH, validation_data= (testing_padded, testing_labels_final),
